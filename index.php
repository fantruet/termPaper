...
?><div>
	<div class="wrap">
		<div class="anime_info" style="border-top: 1px solid rgba(0, 0, 0, 0.135);">
			<div class="container">
				<div class="info">
					<h1 class="h1">
					AnimeGO — смотреть аниме онлайн бесплатно </h1>
					<div class="more_info">
						<p>
	...
	<div class="slider" style="border-top: 1px solid rgba(0, 0, 0, 0.135);">
		<div class="container">
	...
	Array(
		...
		"PROPERTY_CODE" => array(0=>"Age_limit",1=>"Date_next",2=>"Show_date",3=>"Duration",4=>"Genres",5=>"Episodes",6=>"Name_en",7=>"Name_jap",8=>"Name_ru",9=>"Season_number",10=>"Description",11=>"Original_source",12=>"Status",13=>"Studio",14=>"Series_type",15=>"",16=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
 ...
 <section class="viewing" style="border-top: 1px solid rgba(0, 0, 0, 0.135);">
<div class="container">
	<div class="divide">
		<div class="update-block">
			<div class="update-block-head">
				 Обновление аниме
			</div>
			<div>
	...
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"Date",1=>"Name",2=>"Description",3=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
		...
		<div class="news-block">
			...
			<div>
				<ul id="disabled" class="update-list">
					 <?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	"News",
	Array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array(0=>"",1=>"Date",2=>"Name",3=>"Description",4=>"",),
		"SET_BROWSER_TITLE" => "Y",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "Y",
		"SET_META_KEYWORDS" => "Y",
...
<script src="js/jquery-3.6.0.min.js"></script> <script src="js/slick.min.js"></script> <script src="js/main.js"></script>
